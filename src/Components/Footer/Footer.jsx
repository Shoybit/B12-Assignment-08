...
const Footer = () => {
  return (
    <footer className="w-full bg-gradient-to-br from-gray-900 to-[#001931] text-white relative -mb-[29px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Discover amazing apps for every need. Your ultimate destination
              for quality applications across all categories.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <a className="link link-hover text-gray-300 hover:text-white transition-colors block">
                Productivity
              </a>
              <a className="link link-hover text-gray-300 hover:text-white transition-colors block">
                Entertainment
